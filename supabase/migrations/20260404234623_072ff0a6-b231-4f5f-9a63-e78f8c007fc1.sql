...
-- user_roles policies: users can view own roles, admins can view all
...
-- Admin policies on survey_completions
CREATE POLICY "Admins can view all surveys" ON public.survey_completions
  FOR SELECT USING (public.has_role(auth.uid(), 'admin'));
